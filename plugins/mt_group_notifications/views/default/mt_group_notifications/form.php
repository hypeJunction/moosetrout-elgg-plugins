...
$dryrun_flag = 1;
$form_body .= elgg_echo('mt_group_notifications:dryrun');
$form_body .= elgg_view('input/radio', array('label' => elgg_echo('mt_group_notifications:dryrun'),
											'value' => $dryrun_flag,
            								'internalname' => 'dryrun',
...
$form_body .= elgg_echo('mt_group_notifications:displayskipping');
$form_body .= elgg_view('input/radio', array('label' => elgg_echo('mt_group_notifications:displayskipping'),
...
$form_body .= elgg_view('input/radio', array('label' => elgg_echo('mt_group_notifications:defaultnotify'),
											'value' => 'email',
            								...
            								'options' => array(elgg_echo('mt_group_notifications:optionnotifyemail') => 'email',
                                                                ...
                                                                elgg_echo('mt_group_notifications:optionnotifyboth') => 'both')));
