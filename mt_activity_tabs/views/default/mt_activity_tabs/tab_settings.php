...
if (!empty($collections)) {
    ...
    foreach ($collections as $collection) {
        ...
        // radio buttons
        $fb .= "<td>" . elgg_view('mt_activity_tabs/input/radio', array('internalid' => 'mtat_c_' . $collectionid, 'internalname' => 'params[' . $collectionid .']', 'value' => $usersettings->$collectionid, 'js' => 'onclick="mtActivityTabsToggleDefaultRadio(\'collection\', \'' . $collectionid . '\', \'' . $usersettings->$collectionid . '\'); return false;"', 'options' => array('yes'=>'yes', 'no'=>'no'))) . "</td>";
...
if (!empty($groups)) {
    ...
    foreach ($groups as $group) {
        ...
        // radio buttons
        $fb .= "<td>" . elgg_view('mt_activity_tabs/input/radio', array('internalname' => 'params[' . $groupid .']', 'value' => $usersettings->$groupid, 'js' => 'onclick="mtActivityTabsToggleDefaultRadio(\'group\', \'' . $groupid . '\', \'' . $usersettings->$groupid . '\')"', 'options' => array('yes'=>'yes', 'no'=>'no'))) . "</td>";
