...
function mt_rewrite_river_strings_init() {
    ...
    if (get_plugin_setting('enabled', 'mt_rewrite_river_strings')) {
        
        // register post processing hook
        register_plugin_hook('display', 'view', 'mt_rewrite_river_strings_rewrite');
    }
...
function mt_rewrite_river_strings_rewrite($hook, $entity_type, $returnvalue, $params) {
