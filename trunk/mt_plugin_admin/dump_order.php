...
$title = elgg_view_title(elgg_echo('au_admin_plugins:dump_order'), $submenu);

page_draw(elgg_echo('au_admin_plugins:dump_order'), elgg_view_layout("two_column_left_sidebar", '', $title . $body));
